...
class Database {
    ...
    private function connect()
    {
        ...
        $this->hostname = $GLOBALS['CONFIG']->getConfig('SQL_HOST');
        $this->username = $GLOBALS['CONFIG']->getConfig('SQL_USER');
        $this->password = $GLOBALS['CONFIG']->getConfig('SQL_PASSWORD');
        $this->database = $GLOBALS['CONFIG']->getConfig('SQL_DB');
